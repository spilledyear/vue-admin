...
public interface IQuartzService {
     ...
     * @return 触发器列表
     */
    List<TriggerDto> getTriggers(TriggerDto example, int page, int pagesize);
     ...
     * @return job结果列表
     */
    List<JobDetailDto> getJobDetails(JobDetailDto example, int page, int pagesize);
     ...
     * @return job结果列表
     */
    List<JobInfoDetailDto> getJobInfoDetails(JobDetailDto example, int page, int pagesize);
